...
- Linux (gfortran):
  - Debian/Ubuntu (Open MPI): `sudo apt-get install gfortran openmpi-bin libopenmpi-dev`
  - Debian/Ubuntu (MPICH): `sudo apt-get install gfortran mpich`
  - Redhat/CentOS (Open MPI): `sudo yum install gcc-gfortran openmpi openmpi-devel`
  - Redhat/CentOS (MPICH): `sudo yum install gcc-gfortran mpich mpich-devel`
- macOS (Homebrew):
...
1. Baumgardner et al., "Mendel's Accountant: A new population genetics simulation tool for studying mutation and natural selection." In Proceedings of the Sixth International Conference on Creationism, vol. 8798. 2008. [Link](https://www.internationalconferenceoncreationism.com/proceedings-of-the-6th-international-conference-on-creationism-2008/)
1. Sanford et al., "Using numerical simulation to test the validity of neo-Darwinian theory." In Proceedings of the International Conference on Creationism, vol. 6, no. 1, 16. 2008. [Link](https://www.internationalconferenceoncreationism.com/proceedings-of-the-6th-international-conference-on-creationism-2008/)
...
1. Rupe and Sanford, "Using numerical simulation to better understand fixation rates, and establishment of a new principle: Haldane's ratchet." In Proceedings of the International Conference on Creationism, vol. 7, no. 1, p. 32. 2013. [Link](https://www.internationalconferenceoncreationism.com/proceedings-of-the-seventh-international-conference-on-creationism-2013/)
...
1. Sanford et al., "Adam and Eve, designed diversity, and allele frequencies." 2018. [Link](https://www.internationalconferenceoncreationism.com/proceedings-of-the-8th-international-conference-on-creationism-2018/)
