...
! The users own random number generator, randomnum(iseed), is used
! to provide a source of uniformly distributed random numbers.
...
function randomnum1(iseed) result(fn_val)
  ...
  real fn_val, r, rm1, rm2
  integer iseed, m1, m2, m3, j, iff
  integer ia1, ic1, ix1, ia2, ic2, ix2, ia3, ic3, ix3
  parameter (m1=259200, ia1=7141, ic1=54773, rm1=3.8580247e-6)
  parameter (m2=134456, ia2=8121, ic2=28411, rm2=7.4373773e-6)
  parameter (m3=243000, ia3=4561, ic3=51349)
  common /rnd1/ r(97)
  common /rnd2/ iff, ix1, ix2, ix3
  data iff /0/
  ...
  if(iseed<0 .or. iff==0) then
     ...
     do j=1,97
        ...
        r(j) = min(0.999999, (real(ix1) + real(ix2)*rm2)*rm1)
     end do
...
! $Workfile:   r250.f  $
! $Revision: 1.8 $
! $Date: 2013/07/13 08:33:00 $
!
! ===================================================================
!
function lcmrand(ix) result(fn_val)
  ...
  integer ix, fn_val
  integer a, b, m, q, r, hi, lo, test, x
  save x
...
function randomnum2(iseed) result(fn_val)
  
  real fn_val, rrange
  integer iseed
  parameter(rrange = 4.656612873e-10)
  
  fn_val = lcmrand(-iseed)*rrange
  
end function randomnum2
...
! adapted from: http://gcc.gnu.org/onlinedocs/gfortran/RANDOM_005fSEED.html
implicit none
!integer, allocatable :: seed(:)
integer :: seed, x
